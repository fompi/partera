---
id: engineering.audit.base
type: role_base
discipline: engineering
task_type: audit
name: "Base del rol de auditor (engineering)"
version: 1.0.0
description: "Contrato de salida para auditoría: razonamiento, plantilla de hallazgo y reglas de propuestas"
tags: [audit, findings, reasoning, template]
migrated_from: "_base_audit.md (sección de auditoría)"
---

# Base de auditoría (contrato de salida)

> Se compone automáticamente cuando el rol es de tipo audit. Los roles concretos (seguridad, rendimiento, etc.) referencian la plantilla y no la duplican.
