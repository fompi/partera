---
id: engineering.generate.0003_reviewer
type: role
...
- No rehace la implementación completa (rol `0002_implementer`).
- No genera documentación técnica de usuario (rol `0004_documenter`).
