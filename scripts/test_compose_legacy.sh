...
echo "--- Archivos requeridos (en _deprecated/) ---"
check_file_exists "_deprecated/_base_audit.md" "$REPO_DIR/_deprecated/_base_audit.md"
check_file_exists "_deprecated/lang/python.md" "$REPO_DIR/_deprecated/lang/python.md"
check_file_exists "_deprecated/lang/bash.md"   "$REPO_DIR/_deprecated/lang/bash.md"
check_file_exists "_deprecated/00_orchestrator/_index.md" "$REPO_DIR/_deprecated/00_orchestrator/_index.md"
check_file_exists "_deprecated/01_security/_index.md"     "$REPO_DIR/_deprecated/01_security/_index.md"
check_file_exists "_deprecated/02_performance/_index.md"  "$REPO_DIR/_deprecated/02_performance/_index.md"
check_file_exists "_deprecated/04_correctness/_index.md"  "$REPO_DIR/_deprecated/04_correctness/_index.md"
echo ""
