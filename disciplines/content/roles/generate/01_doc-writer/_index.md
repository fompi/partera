---
id: content.generate.01_doc-writer
type: role
discipline: content
task_type: generate
...
- No genera el código que documenta (rol `engineering.generate.02_implementer`).
- No toma decisiones de arquitectura; las documenta.
- No crea contenido de marketing del producto (rol `content.generate.03_copywriter`).
