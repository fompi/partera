---
id: design.create.0000_web-designer
type: role
discipline: design
task_type: create
name: "Diseñador Web"
...
- No investiga usuarios de forma autónoma (rol `design.create.0001_ux-researcher` complementa esto).
- No implementa el diseño en código (rol `engineering.generate.0005_frontend-dev`).
