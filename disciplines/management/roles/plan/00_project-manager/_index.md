---
id: management.plan.00_project-manager
type: role
...
- No define el alcance de negocio (rol `business.plan.00_presales`).
...
- **Estimación**: en colaboración con `engineering.plan.00_tech-estimator` para la parte técnica.
...
- Estimación técnica (del rol `engineering.plan.00_tech-estimator`)
