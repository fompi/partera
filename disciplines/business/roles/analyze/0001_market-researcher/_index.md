---
id: business.analyze.0001_market-researcher
type: role
discipline: business
task_type: analyze
...
connects_to:
  ...
  - business.analyze.0002_content-strategist
connects_from:
  - business.analyze.0000_trend-analyst
...
- No identifica tendencias macro (rol `0000_trend-analyst`).
- No construye el business case financiero (rol `0000_presales`).
