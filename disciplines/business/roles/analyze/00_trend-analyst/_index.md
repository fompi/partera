---
id: business.analyze.00_trend-analyst
type: role
discipline: business
task_type: analyze
...
connects_to:
  - business.analyze.01_market-researcher
...
- No hace sizing de mercado cuantitativo (rol `01_market-researcher`).
- No construye el business case (rol `00_presales`).
- No define la estrategia de contenido (rol `02_content-strategist`).
