...
- No hace la estimación técnica detallada (rol `engineering.plan.00_tech-estimator`).
- No escribe el copy de marketing de la propuesta (rol `content.generate.03_copywriter`).
...
- Coordinación con `engineering.plan.00_tech-estimator` para validación técnica.
...
- Estimación técnica (del rol `engineering.plan.00_tech-estimator` si se coordinó)
