---
id: engineering.generate.01_tech-advisor
type: role
...
- No genera la especificación (rol `00_spec-writer`).
- No implementa el código (rol `02_implementer`).
- No estima el esfuerzo de implementación con el stack elegido (rol `plan/00_tech-estimator`).
