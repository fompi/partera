---
id: engineering.generate.00_spec-writer
type: role
...
- No elige el stack tecnológico (rol `01_tech-advisor`).
- No genera código de implementación (rol `02_implementer`).
- No estima esfuerzo ni planifica (rol `plan/00_tech-estimator`).
