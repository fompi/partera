---
id: engineering.generate.02_implementer
type: role
...
connects_to:
  ...
  - engineering.generate.04_documenter
connects_from:
  - engineering.generate.00_spec-writer
  - engineering.generate.01_tech-advisor
...
- No toma decisiones de arquitectura o stack (roles `00_spec-writer`, `01_tech-advisor`).
- No revisa su propio código en profundidad (rol `03_reviewer`).
- No genera documentación de usuario final (rol `04_documenter`).
