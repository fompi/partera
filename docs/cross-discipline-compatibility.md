...
Este documento describe las relaciones entre roles de distintas disciplinas, mostrando cómo se componen flujos de trabajo multi-disciplinares. Las conexiones entre disciplinas demuestran que el sistema no es un conjunto de silos sino una red de roles colaborativos.
...
### Incompatibilidades (deben fallar)
